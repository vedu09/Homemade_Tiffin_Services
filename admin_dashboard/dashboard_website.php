...
?>
    ...
    <div class="activity">
        <div class="list">
            <ul>
                ...
                <li><a href="dashboard_website.php" style="color:yellow;border-bottom: 3px solid red;">Website Feedback Details</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="main">
        ...
        <h2 style="text-align:center;font-size:45px;font-family: 'IM Fell Great Primer SC', serif;">Website Feedback Details </h2>
