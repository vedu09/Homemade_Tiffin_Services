...
?>
    ...
    <div class="activity">
        <div class="list">
            <ul>
                ...
                <li><a href="dashboard_user.php" style="color:yellow;border-bottom: 3px solid red;">User Details</a></li>
    ...
    <div class="main">
        ...
        <h2 style="text-align:center;font-size:45px;font-family: 'IM Fell Great Primer SC', serif;">User Form Details </h2>
