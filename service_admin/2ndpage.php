...
<body>
    ...
    <div class="bg">
        <img src="gradient2.png" alt="" height="2100px">
    ...
    <form id="searchForm" method="POST">
        ...
        <div class="contain">
            ...
            <div style="margin-left:10px;margin-top:14px;font-size:18px;width:18px;height:20px;position:absolute;"><i class="fa-solid fa-location-dot"></i></div>
            <input class="location" list="browsers" name="browser" placeholder="Location" value="<?php echo$x;?>" id="browser" onchange="submitForm()">
                    ...
                    <input class="tiffin" list="tiffin" name="tiffin" placeholder="Search for Tiffin Service" value="" >
    ...
    <?php
       if(isset($_POST['sub']))
       {
            $a=ucwords(strtolower($_POST['browser']));
            $b=ucwords(strtolower($_POST['tiffin']));
           ...
           if($a!=NULL && $b==NULL)
           {
            ...
            // echo "<script>alert('okay $a')</script>";

            $query="select count(id) from tiffin_info where city='$a';";
            $result=pg_query($con,$query);
            $row=pg_fetch_row($result);
            if($row[0]==0)
            {
                echo"<script>alert('No services in $a Loation / Area')</script>";
                echo "<script>window.location.href='2ndpage.php'</script>";
           ...
           if($a!=NULL and $b!=NULL){
            $query="select count(id) from tiffin_info where service_name='$b' and city='$a';";
            $result=pg_query($con,$query);
            $row=pg_fetch_row($result);
            if($row[0]==0)
            {
                echo"<script>alert('Sorry ($b) This Service Didnt Exists..!!')</script>";
                echo "<script>window.location.href='2ndpage.php'</script>";
            ...
            {
                $_SESSION['tf']=$b;
                // echo "<script>alert('hello $x')</script>";
    ...
    <div class="filters">
        <div class="c1" style="background-color: blue;">
            <a href="3rdpage.php?value=vn"><img src="mt.png" alt="" class="img"></a>
        </div>
        <div class="c2" style="background-color: palevioletred;">
            <a href="3rdpage.php?value=g"><img src="gt.png" alt="" class="img"></a>
        </div>
        <div class="c3" style="background-color: green;">
            <a href="3rdpage.php?value=r"><img src="rt.png" alt="" class="img"></a>
        </div>
        <div class="c4" style="background-color: yellow;">
            <a href="3rdpage.php?value=n"><img src="nt.png" alt="" class="img"></a>
        </div>
    </div>
    ...
    $con=pg_connect("host=localhost dbname=tiffin_service user=postgres password=090403");
    $query="select service_name,profile_pic from tiffin_info where city='$x';";
    $result=pg_query($con,$query);
