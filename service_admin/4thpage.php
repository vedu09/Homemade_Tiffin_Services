...
<body>
    ...
    <div class="bg">
        <img src="gradient2.png" alt="" height="1150px">
    ...
    <form  method="POST">
        ...
        <div class="contain">
            ...
            <input class="location" list="browsers" name="browser" placeholder="Enter Location  eg: Kothrud, Pune" value="<?php echo$x;?>" id="browser">
                    ...
                    <input class="tiffin" list="tiffin" name="tiffin" placeholder="Search for Tiifns in Nearby Area" value="<?php echo$tf;?>" >
    ...
    <?php
       if(isset($_POST['sub']))
       {
           ...
           if($x!=NULL && $b==NULL)
           {
            ...
            $x=$_SESSION['location'];
            // echo "<script>alert('okay $x')</script>";
        
            echo "<script>window.location.href='2ndpage.php'</script>";
           }
           else if($b!=NULL and $x!=NULL){
            $_SESSION['tf']=$b;
    ...
    $con=pg_connect("host=localhost dbname=tiffin_service user=postgres password=090403");
    $query="select service_name,profile_pic from tiffin_info where service_name='$tf' and city='$x';";
    $result=pg_query($con,$query);
